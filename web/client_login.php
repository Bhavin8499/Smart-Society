    ...
    <div class="slider_area">
        <div class="single_slider  d-flex align-items-center slider_bg_1">
            <div class="container">
				...
				<form class="row contact_form" action="client_login_code.php" method="post" id="loginform">
                    ...
                    <div class="col-lg-12 col-md-3">
                        ...
                        <div class="payment_form white-bg wow fadeInDown" data-wow-duration="1.2s" data-wow-delay=".2s">
                            ...
                            <div class="submit_btn">
                                <button class="boxed-btn3" type="submit" name="submit" value="submit">Login</button>
                            </div>
                        </div>
                    </div>
                    </div>
