                    ...
                    <div class="bg-white tm-block h-100">
                        <div class="row">
                            <div class="col-md-8 col-sm-12">
                                <h2 class="tm-block-title d-inline-block">Bills</h2>

                            </div>
                            <div class="col-md-4 col-sm-12 text-right">
                                <a href="add_bill" class="btn btn-small btn-primary">Add New Bill</a>
                            </div>
                        </div>
                       ...
                       <td><a class="fas fa-trash-alt tm" href="delete_bill"></a></td>
                                        <!-- Editing Bill -->
                     <td><a class="fas fa-edit" href="edit_bill"></a></td>          
                                    </tr>
                                    <tr>
